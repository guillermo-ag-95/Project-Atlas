...
class DeviceMotionService {
	...
	private let queue: OperationQueue = .init(maxConcurrentOperationCount: 1)
	private let repository: DeviceMotionRepositorySyncProtocol = CoreMotionRepository.shared
